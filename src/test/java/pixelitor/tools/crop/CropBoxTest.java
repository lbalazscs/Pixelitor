...
class CropBoxTest {
    ...
    void keepAspectRatio_by_north_or_south_handle() {
        ...
        CropBox.keepAspectRatio(rect, Cursor.N_RESIZE_CURSOR, 0.5);
        assertThat(rect).isEqualTo(rectExpected);

        CropBox.keepAspectRatio(rect, Cursor.S_RESIZE_CURSOR, 0.5);
        assertThat(rect).isEqualTo(rectExpected);
    }
    ...
    void keepAspectRatio_by_west_or_east_handle() {
        ...
        CropBox.keepAspectRatio(rect, Cursor.E_RESIZE_CURSOR, 0.5);
        assertThat(rect).isEqualTo(rectExpected);

        CropBox.keepAspectRatio(rect, Cursor.W_RESIZE_CURSOR, 0.5);
        assertThat(rect).isEqualTo(rectExpected);
    }
    ...
    void keepAspectRatio_by_north_east_handle() {
        ...
        CropBox.keepAspectRatio(rect, Cursor.NE_RESIZE_CURSOR, 0.5);
        assertThat(rect).isEqualTo(rectExpected);
    ...
    void keepAspectRatio_by_north_west_handle() {
        ...
        CropBox.keepAspectRatio(rect, Cursor.NW_RESIZE_CURSOR, 0.5);
        assertThat(rect).isEqualTo(rectExpected);
