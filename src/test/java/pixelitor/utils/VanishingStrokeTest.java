...
class VanishingStrokeTest {
    ...
    void testingPerpendicularCalculation() {
        ...
        VanishingStroke.perpendiculars(A, B, (float) Math.sqrt(2), P, Q);
...
//                   |
    ...
    public static void main(String[] args) {
        new VanishingStrokeTest().testingTheStroke();
    }
    ...
    void testingTheStroke() {
        ...
        g.setStroke(new VanishingStroke(30));
        g.draw(path);
