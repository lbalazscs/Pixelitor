...
public class ScribbleTransition2D extends Transition2D {
    ...
    private final boolean twoPasses;
    ...
    public Transition2DInstruction[] getInstructions(float progress, Dimension size) {
        ...
        if (!twoPasses) {
            ...
            float progress1 = progress / 0.5f;
            if (progress1 > 1) {
                progress1 = 1;
            }
            Shape subShape1 = ShapeUtils.traceShape(scribble, progress1);
            BasicStroke stroke = new BasicStroke(16.7f * 0.5f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
            ...
            float progress2 = (progress - 0.5f) / 0.5f;
            if (progress2 < 0) {
                progress2 = 0;
            }
