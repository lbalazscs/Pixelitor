...
public abstract class AbstractPlanarTransition2D extends Transition2D {
    ...
    public Transition2DInstruction[] getInstructions(float progress, Dimension size) {
        ...
        Point2D p = new Point2D.Double(0, 0.5);
        ...
        ShapeInstruction i1ShadowB = new ShapeInstruction(shadow1Rect, getShade(1 - opacity1 * 0.3f));
        ImageInstruction i2ShadowA = new ImageInstruction(false, transform2z, null);
        ShapeInstruction i2ShadowB = new ShapeInstruction(shadow2Rect, getShade(1 - opacity2 * 0.3f));
