...
public abstract class MultiThumbSlider extends JComponent {
     ...
     */
    protected MultiThumbSlider(int orientation, float[] thumbPositions, Object[] values) {
    ...
    public void setPaintTicks(boolean b) {
        ...
        paintTicks = b;
        firePropertyChange(PAINT_TICKS_PROPERTY, Boolean.valueOf(!b), Boolean.valueOf(b));
    }
    ...
    public int addThumb(float pos) {
        ...
        if (pos < thumbPositions[0]) {
            ...
            for (int a = 0; a < f.length; a++) {
                if (!addedYet && thumbPositions[a] < pos) {
    ...
    public void setValueIsAdjusting(boolean b) {
        ...
        adjusting = b;
        firePropertyChange(ADJUST_PROPERTY, Boolean.valueOf(!b), Boolean.valueOf(b));
    }
    ...
    public void setSelectedThumb(int index) {
        putClientProperty(SELECTED_THUMB_PROPERTY, index);
    }
    ...
    public void setOrientation(int i) {
        ...
        orientation = i;
        firePropertyChange(ORIENTATION_PROPERTY,
                Integer.valueOf(oldValue), Integer.valueOf(i));
    }
    ...
    public void setInverted(boolean b) {
        ...
        inverted = b;
        firePropertyChange(INVERTED_PROPERTY, Boolean.valueOf(!b), Boolean.valueOf(b));
    }
}
