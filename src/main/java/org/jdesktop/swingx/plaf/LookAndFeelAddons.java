...
//      if (!UIManager.getBoolean(APPCONTEXT_INITIALIZED)) {
     ...
     *
     * @param tracking true to automatically update the addon, false to not automatically
     ...
     * @throws IllegalArgumentException if the component does not contain the "backgroundPainter"
