...
public enum ImageBrushType {
    ...
    /**
     * Creates a brush template that is not colorized yet. Areas that should be transparent
     * in the final brush image are white, and semi-transparent pixels are gray.
     */
