...
public class GradientTool extends Tool {
    ...
    public void initSettingsPanel() {
        ...
        typeSelector.setName("gradientTypeSelector");
        ...
        cycleMethodSelector.setName("gradientCycleMethodSelector");
