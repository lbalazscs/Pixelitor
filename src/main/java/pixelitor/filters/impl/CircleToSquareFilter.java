...
public class CircleToSquareFilter extends CenteredTransformFilter {
    ...
    public Shape[] getAffectedAreaShapes() {
        Rectangle2D rect = new Rectangle2D.Float(cx - radiusX, cy - radiusY, 2 * radiusX, 2* radiusY);
        Ellipse2D ellipse = new Ellipse2D.Float(cx - radiusX, cy - radiusY, 2 * radiusX, 2* radiusY);
